...
import 'package:qrcode/models/class_refeicao.dart';
            ...
            child: resultInternet
                ? Column(
                    ...
                    children: <Widget>[
                      ...
                      Center(
                        child: Text(
                          "Primeiro selecione a instituição abaixo:",
                      ...
                      Center(
                        child: Text(
                          "Agora selecione APENAS uma opção abaixo:",
                          style: TextStyle(fontSize: 14, color: Colors.red),
                        ),
                      ),
                      ...
                      ElevatedButton(
                        ...
                        child: Row(
                          children: [
                            Image.asset("images/cafealmoco.png"),
                            SizedBox(
                              width: 10.0,
                            ),
                            Text(
